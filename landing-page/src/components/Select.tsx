...
const SelectDemo = () => (
	<Select.Root>
		<Select.Trigger
			className="flex w-full h-[35px] items-center justify-center gap-[5px] rounded bg-white px-[15px] text-[13px] leading-none text-white shadow-[0_2px_10px] shadow-black/10 outline-none hover:bg-grey-300 focus:shadow-[0_0_0_2px] focus:shadow-black data-[placeholder]:text-white "
			aria-label="Food"
		>
